...
std::string App::demangle(const std::type_info &v)
{
	return App::demangle(v.name());
}

std::string App::demangle(const std::type_index &v)
{
	return App::demangle(v.name());
}

std::string App::demangle(const char* mangled_name)
{
